...
단가 변경 이력 · **정확한 회계 마진**(매입처별 원가·매입이력·재고 평가·세무 반영, 1차 예상 참고 마진과 구분) · 미수금/입금 본격 관리 · 오래된 미수금 알림 · 거래처별 월 정산표 · 직원 계정/권한 UI · 세금계산서 발행 금액 부족/초과 표시 · 거래처 주문 링크 · OCR · 외부 ERP 연동.
